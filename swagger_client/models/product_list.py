...
from swagger_client.models.product_list_row import ProductListRow  # noqa: F401,E501
...
class ProductList(object):
    ...
    @property
    def p(self):
        """Gets the p of this ProductList.  # noqa: E501


        :return: The p of this ProductList.  # noqa: E501
        :rtype: list[ProductListRow]
        """
        return self._p

    @p.setter
    def p(self, p):
        """Sets the p of this ProductList.


        :param p: The p of this ProductList.  # noqa: E501
        :type: list[ProductListRow]
        """
        if p is None:
